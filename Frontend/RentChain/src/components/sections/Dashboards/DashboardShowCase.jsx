    ...
    <div className="w-full section-page">
      {pathname == "/dashboard/landlord-dashboard" ? (
        <div className="grid justify-between w-full grid-cols-2 gap-10 md:grid-cols-3 lg:grid-cols-4">
          <div className="w-full p-6 bg-white border border-gray-200 shadow-sm rounded-xl space-y-7">
            ...
            <h3 className="text-4xl font-semibold md:text-6xl">6</h3>
          ...
          <div className="w-full p-6 bg-white border border-gray-200 shadow-sm rounded-xl space-y-7">
            ...
            <h3 className="text-4xl font-semibold md:text-6xl">$24,500</h3>
          ...
          <div className="w-full p-6 bg-white border border-gray-200 shadow-sm rounded-xl space-y-7">
            ...
            <h3 className="text-4xl font-semibold md:text-6xl">2</h3>
        ...
        <div className="grid justify-between w-full grid-cols-2 gap-10 md:grid-cols-3 lg:grid-cols-4">
          <div className="w-full p-6 bg-white border border-gray-200 shadow-sm rounded-xl space-y-7">
            ...
            <h3 className="text-4xl font-semibold md:text-6xl">$1,200</h3>
          ...
          <div className="w-full p-6 bg-white border border-gray-200 shadow-sm rounded-xl space-y-7">
            ...
            <h3 className="text-4xl font-semibold md:text-6xl">850</h3>
          ...
          <div className="w-full p-6 bg-white border border-gray-200 shadow-sm rounded-xl space-y-7">
            ...
            <h3 className="text-4xl font-semibold md:text-6xl">12</h3>
          ...
          <div className="w-full p-6 bg-white border border-gray-200 shadow-sm rounded-xl space-y-7">
            ...
            <h3 className="text-4xl font-semibold md:text-6xl">5</h3>
