...
export default function Chat() {
  ...
  if (!state?.title) {
    return (
      <div className="px-4 mx-auto max-w-7xl !py-52 section-page">
        <h2 className="mb-4 text-5xl font-bold">Chat</h2>
        <p className="mb-6 text-2xl text-red-500">No property selected. Please select a property first.</p>
        <button
          onClick={() => navigate("/dashboard/tenant-dashboard/properties")}
          className="px-6 py-3 text-2xl text-white bg-primary rounded-xl hover:bg-blue-700"
        >
          Browse Properties
        </button>
      </div>
