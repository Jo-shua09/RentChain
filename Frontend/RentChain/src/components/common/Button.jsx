...
export const ButtonTwo = ({ icon, name, onClick, className }) => {
	return (
		<button
			onClick={onClick}
			className={`px-8 py-6 bg-white text-primary text-[1.7rem] text-nowrap capitalize font-semibold rounded-xl flex items-center gap-x-6 hover:scale-95 ${className}`}
		>
			{icon} {name}
		</button>
	);
