  ...
  return (
    <div className="flex items-center justify-center w-full h-screen max-h-screen bg-gray-50">
      <div className="flex flex-col items-center w-full">
        ...
        <h3 className="text-5xl font-semibold normal-case pb-7 text-secondary">Decentralized Rental Management Platform</h3>
        <p className="text-[1.7rem] font-medium normal-case text-secondary">Connect your wallet to access the blockchain-powered rental ecosystem</p>
